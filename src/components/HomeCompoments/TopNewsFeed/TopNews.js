                            ...
                            <div className="row">
                                ...
                                <div className="col-md-6">
                                    <div className="CustomBorder">
                                        ...
                                        <NavLink className="btn btn-danger"
                                                 to={"https://pulse-of-the-underground.com/article/SINGLE-REVIEW:-The-Flame-Ignites-My-Darkest-Reds-Melancholic-Majestyhttps://pulse-of-the-underground.com/article/SINGLE-REVIEW:-The-Flame-Ignites-My-Darkest-Reds-Melancholic-Majesty"}>
                                            Read More
                                        </NavLink>
                                    </div>
                                </div>
