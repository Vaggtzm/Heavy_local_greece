        ...
        < div className="container">
            <div className="row">
                ...
                <div className="col-md-6 bg-secondary p-4">
                     <h4>Scent Of Thorns-Devour the will:Κριτική απο τον Μιχαλη Αντονωπουλο </h4>
                ...
                <hr className="bg-dark"></hr>
                <div className="col-md-6 bg-secondary p-4">
                     <h4>StartTheMonkey-Urban Psyche :Κριτική απο τον Βαγγελη Τζιμα </h4>
                ...
                <hr className="bg-dark"></hr>
                <div className="col-md-6 bg-secondary p-4">
                     <h4>Lioneye-S.E.X: Κριτική απο τον Βαγγελη Τζιμα </h4>
