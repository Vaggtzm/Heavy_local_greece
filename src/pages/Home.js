          ...
          <div className="col-md-6 m-2">
             <div className="card h-100 w-100">
                <img
                  ...
                  src={
                    "https://pulse-of-the-underground.com/assets/a0404193695_16.jpg"
                  }
                  alt="Disimulator"
                ></img>
                <div className="card-body">
                  <h4 className="card-title">
                  Vosar Strikes Back - Forbidden Myth - Zantea Chronicles: The Nightmare Awakens (Album Review)
                                    </h4>
                  <a
                    href="/article/Vosar-Strikes-Back---Forbidden-Myth---Zantea-Chronicle-The-Nightmare-Awakens-Album-Review"
